// src/components/NewReport/template3/GenerateTab.tsx
...
const GenerateTab3: React.FC<GenerateTab3Props> = ({
  uploadedImages,
  MAX_IMAGES,
  statuses,
  isGenerating,
          ...
          {isGenerating ? (
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="text-inspectoriq-blue font-medium">
                  Generating PROSERVE Report... {generationProgress}%
                </span>
              </div>
            ...
            <div className="flex justify-center">
              <Button
                ...
                disabled={!statuses.details || !statuses.images || !statuses.template}
              >
