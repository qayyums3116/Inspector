// src/components/NewReport/template1/GenerateTab.tsx
            ...
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="text-inspectoriq-blue font-medium">
                  Generating VERSA report... {generationProgress}%
                </span>
              </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
            ...
            <p className="text-gray-500 text-sm mb-4">
              Your feedback helps us improve the report generation process.
            </p>
