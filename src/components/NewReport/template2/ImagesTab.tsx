...
const ImagesTab2: React.FC<ImagesTab2Props> = ({
  uploadedImages,
  captions,
  setCaption,
  handleImageUpload,
  ...
  const onDrop = useCallback(
    (e: React.DragEvent<HTMLDivElement>) => {
      ...
      // Default the very first caption
